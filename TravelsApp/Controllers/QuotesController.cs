...
namespace TravelsApp.Controllers
{
    ...
    public class QuotesController : Controller
    {
        ...
        public async Task<ActionResult> EmailQuote(int? id)
        {
            ...
            string currentDate = "Estimate Created On " + DateTime.Now.ToString(); //NoToString
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserID,FirstName,LastName,PhoneNumber,NumAdults,NumKids,DepartureDate,ReturnDate,TourL,CruiseL,FlightL,HotelL")] Quote quote)
        {
